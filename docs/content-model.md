...
| `config/commerce.ts` | currency, local-currency notes (`localCurrencyNote`, `localCurrencyNoteShort`), guarantee (7 days), passthrough allowlist, Hotmart URLs | product README 2026-08-04, Hotmart docs |
